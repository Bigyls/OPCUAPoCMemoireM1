...
## Communication avec chiffrement
...
s.load_certificate("./certs/server_cert.pem")
s.load_private_key("./certs/server_key.pem")
...
client.set_security_string("Basic256Sha256,SignAndEncrypt,certs/client_cert.pem,certs/client_key.pem")
